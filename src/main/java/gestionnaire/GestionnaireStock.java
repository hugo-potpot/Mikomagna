...
/**
 * Un objet de type GestionnaireStock permet de gérer un stock d'articles à
 * travers un menu. Il est donc associé à un stock.
 * 
 * 
...
final public class GestionnaireStock extends GestionnaireMenu {
	 ...
	 */
	static final private String[] menu = { "Afficher tous les articles",
			"Afficher les articles d'une certaine catégorie", "Afficher les informations d'un article",
			"Ajouter un nouvel article (\"catégorie Aucune\")", "Ajouter un nouvel article de type ArticleCat1",
			"Ajouter un nouvel article de type ArticleCat2", "Supprimer un article", "Modifier un article",
			"Changer la quantité en stock d'un article", "Quitter" };
	...
	/**
	 * Méthode permettant d'associer les entrées du menu d'un gestionnaire de stock
	 * avec les traitements correspondants.
	 * 
