...
/**
 * Un objet de type GestionnaireCommandes permet de gérer un ensemble de
 * commandes à travers un menu. Il est associé à un carnet de clients et à un
 * stock d'articles.
 * 
 * 
...
final public class GestionnaireCommandes extends GestionnaireMenu {
	 ...
	 */
	static final private String[] menu = { "Afficher les commandes",
			"Afficher les clients du carnet de clients utilisé", "Afficher les articles du stock utilisé",
			"Créer et éditer une nouvelle commande", "Editer une commande", "Supprimer une commande", "Quitter" };

	/**
	 * Constructeur permettant de créer un gestionnaire de commandes.
	 * 
	 * @param commandes     L'ensemble des commandes géré par le gestionnaire de
	 *                      commandes.
	 * @param carnetClients Le carnet de clients utilisé par le gestionnaire de
	 *                      commandes.
	 * @param stock         Le stock d'articles utilisé par le gestionnaire de
	 *                      commandes.
	 */
