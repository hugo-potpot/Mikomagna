...
/**
 * Un objet de type GestionnaireClients permet de gérer un carnet de clients à
 * travers un menu. Il est donc associé à un carnet de clients.
 * 
 * 
...
final public class GestionnaireClients extends GestionnaireMenu {
	 ...
	 */
	static final private String[] menu = { "Afficher tous les clients",
			"Afficher tous les clients par ordre alphabétique des noms", "Afficher les clients de type Particulier",
			"Afficher les clients de type Entreprise", "Afficher les informations d'un client",
			"Ajouter un nouveau client de type Particulier", "Ajouter un nouveau client de type Entreprise",
			"Supprimer un client", "Modifier un client", "Rechercher des clients par un mot clé", "Quitter" };

	/**
	 * Constructeur permettant de construire un gestionnaire de menu permettant de
	 * gérer un carnet de clients.
	 * 
	 * @param carnetClients Le carnet de clients devant être géré par le
	...
	/**
	 * Méthode permettant d'associer les entrées du menu d'un gestionnaire de carnet
	 * de clients avec les traitements correspondants.
	 * 
