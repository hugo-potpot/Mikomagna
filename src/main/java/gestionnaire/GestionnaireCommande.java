...
/**
 * Un objet de type GestionnaireCommande permet d'éditer une commande à travers
 * un menu. Il est associé à une commande et à un stock d'articles.
 * 
 * 
...
final public class GestionnaireCommande extends GestionnaireMenu {
	 ...
	 */
	static final private String[] menu = { "Afficher la commande", "Afficher les articles du stock utilisé",
			"Ajouter un produit dans la commande", "Supprimer un article de la commande", "Clôturer la commande",
			"Quitter" };
	...
	protected void traiterEntreeMenu(int numEntree) {
		...
		case 4:
			...
			commande.cloturer(
					Util.questionBinaire("Les articles livrables de la commande seront livrés (o/n) ?", "o", "n"));
			System.out.println("Commande clôturée !");
			System.out.println(commande);
			break;
		case 5:
