...
/**
 * Un objet de type GestionnairePrincipal permet de gérer le menu principal de
 * l'application de gestion des ventes. Il est associé à un ensemble de
 * commandes, à un carnet de clients et à un stock d'articles.
 * 
 * 
...
final public class GestionnairePrincipal extends GestionnaireMenu {
	 ...
	 */
	static final private String[] menu = { "Gérer le carnet de clients", "Gérer le stock des articles",
			"Gérer les commandes", "Quitter" };

	/**
	 * Constructeur permettant de créer un gestionnaire principal.
	 * 
	 * @param titreMenu     Titre du menu principal.
	 * @param commandes     L'ensemble des commandes géré par le gestionnaire
	 *                      principal.
	 * @param carnetClients Le carnet de clients utilisé par le gestionnaire
	 *                      principal.
	 * @param stock         Le stock d'articles utilisé par le gestionnaire
	 *                      principal.
	 */
	public GestionnairePrincipal(String titreMenu, EnsembleCommandes commandes, CarnetClients carnetClients,
			Stock stock) {
	...
	/**
	 * Méthode permettant d'associer les entrées du menu d'un gestionnaire de
	 * commande avec les traitements correspondants.
	 * 
