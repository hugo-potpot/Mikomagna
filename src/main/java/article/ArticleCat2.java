...
/**
 * Chaque objet de cette classe correspond à un article de type vélo. Ce type
 * d'article peut être livré.
 * 
...
public class ArticleCat2 extends Article implements Livrable {
	...
	/**
	 * Constructeur permettant de créer un nouvel article de type vélo. Son numéro
	 * de référence est généré automatiquement. Sa catégorie est toujours "Vélos".
	 * 
	 ...
	 *                      quantité).
	 * @param poids         Le poids du vélo en kg (si strictement inférieur à 0.0
	 *                      alors 15 est mis par défaut).
	 */
	...
	/**
	 * Constructeur permettant de créer un nouvel article de catégorie "Vélos". Son
	 * numéro de référence est généré automatiquement. Sa catégorie est toujours
	 * "Vélos". Les autres informations sont saisies au clavier avec la méthode
	 * saisirInfos().
	 */
	public ArticleCat2() {
	}
	...
	/**
	 * Méthode permettant de saisir la désignation, le prix, la quantité en stock et
	 * le poids d'un article de catégorie "Vélos".
	 */
	 ...
	 * 
	 * @param poids Le nouveau poids du vélo en kg (si strictement inférieur à 0.0
	 *              alors 15.0 est mis par défaut).
	 */
