...
/**
 * Cette interface spécifie les méthodes nécessaires aux articles pouvant être
 * livrés.
 *
...
public interface Livrable {
	...
	/**
	 * Méthode retournant une chaîne de caractères représentant les informations sur
	 * l'article Livrable concernant les caractéristiques nécessaires à son
	 * transport.
	 * 
	 * @return Les informations sur l'article livrable.
	 */
	default public String infosLivrable() {
		return "[Haut. : " + getHauteurColis() + " cm | Larg. : " + getLargeurColis() + " cm | Prof. : "
				+ getProfondeurColis() + " cm | Poids : " + getPoidsKgColis() + " kg]";
	}

	/**
	 * Méthode retournant le coût de livraison de l'article livrable : 1.5 euros par
	 * m3 du volume du colis + 1.1 euro par kg du colis.
	 * 
