...
/**
 * Un objet de la classe Client correspond à un client. Chaque client a une
 * référence (un entier) permettant de l'identifier, un nom (une chaîne de
 * caractères), une adresse (une chaîne de caractères) et un nombre de points de
 * fidélité (un entier).
 * 
...
abstract public class Client {
	...
	/**
	 * La référence du client. Le premier client aura la référence 0, le deuxième la
	 * référence 1, le troisième la référence 2 ...
	 */
	...
	/**
	 * Constructeur permettant d'initialiser un nouveau client avec son nom, son
	 * adresse et ses points de fidélité. Son numéro de référence est généré
	 * automatiquement.
	 * 
	...
	/**
	 * Constructeur permettant d'initialiser un nouveau client en effectuant la
	 * saisie au clavier de son nom, son adresse et ses points de fidélité (en
	 * utilisant la méthode saisirInfos()). Son numéro de référence est généré
	 * automatiquement.
	 */
	protected Client() {
		reference = nbClients++;
	...
	/**
	 * Les points de fidélité donnent droit à une ristourne sur le montant total
	 * d'une commande. Cette ristourne est calculé de la manière suivante : Un
	 * client ayant entre 100 et 499 points de fidelité a droit à une ristourne de
	 * 5% sur le montant total. Un client ayant entre 500 et 999 points de fidelité
	 * a droit à une ristourne de 10% sur le montant total. Un client ayant 1000
	 * points ou plus de fidelité a droit à une ristourne de 15% sur le montant
	 * total.
	 * 
	 ...
	 * 
	 * @param pointsFidelite Le nouveau nombre de points de fidélité (supposé
	 ...
	 * 
	 * @param clients Le tableau contenant les clients à afficher, chaque case du
	 *                tableau contient une référence non null d'un Client.
	 */
	...
	/**
	 * Méthode permettant de trier un tableau de clients selon l'ordre alphabétique
