...
/**
 * Un objet de la classe ClientParticulier représente un client correspondant à
 * un particulier. Un client qui est un particulier a un nom de contact comme
...
public class ClientParticulier extends Client {
	 ...
	 * avec son nom, son adresse, son prénom et son genre. Son numéro de référence
	 ...
	 * genre (en utilisant la méthode saisirInfos()). Son numéro de référence est
	...
	/**
	 * Méthode permettant de saisir le nom, l'adresse, le prénom et le genre d'un
	 * client de type particulier.
	 */
