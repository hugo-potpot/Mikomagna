...
/**
 * Un objet de la classe ClientEntreprise représente un client correspondant à
 * une entreprise. Un client qui est une entreprise a un nom de contact (une
 * chaîne de caractères) comme caractéristique supplémentaire.
 * 
...
public class ClientEntreprise extends Client {
	...
	/**
	 * Constructeur permettant d'initialiser un nouveau client de type entreprise
	 * avec son nom, son adresse et le nom du contact. Son numéro de référence est
	...
	/**
	 * Constructeur permettant d'initialiser un nouveau client de type entreprise en
	 * effectuant la saisie au clavier de son nom, son adresse et le nom de son
	 * contact (en utilisant la méthode saisirInfos()). Son numéro de référence est
	 * généré automatiquement.
	 */
	...
	/**
	 * Méthode permettant de saisir le nom, l'adresse et le contact d'un client de
	 * type entreprise.
	 */
