...
public class Util {
	...
	/**
	 * Méthode permettant d'effectuer la saisie au clavier d'un nombre entier
	 * compris (au sens large) entre deux valeurs (min et max). Un message (si non
	 * null) est affiché à l'écran avant d'effectuer la saisie.
	 * 
	 * @param min     La valeur minimale.
	 * @param max     La valeur maximale (max doit être supérieure ou égal à min).
	 * @param message Le message affiché avant la saisie (si null rien n'est
	 *                affiché).
	...
	/**
	 * Méthode permettant d'effectuer la saisie au clavier d'un nombre entier
	 * positif (possiblement 0). Un message (si non null) est affiché à l'écran
	...
	/**
	 * Méthode permettant d'effectuer la saisie au clavier d'un nombre entier
	 * compris (au sens large) entre deux valeurs (min et max).
	 * 
	 * @param min La valeur minimale.
	 * @param max La valeur maximale (max doit être supérieure ou égal à min).
	 * @return Un entier saisi au clavier compris entre min et max (au sens large).
	...
	/**
	 * Méthode permettant d'effectuer la saisie au clavier d'un nombre de type
	 * double (possiblement 0.0). Un message (si non null) est affiché à l'écran
	 * avant d'effectuer la saisie.
	 * 
	 * @param message Le message affiché avant la saisie (si null rien n'est
	 *                affiché).
	...
	/**
	 * Méthode permettant de saisir une chaîne de caractères contenant au moins un
	 * caractère. Un message (si non null) est affiché à l'écran avant d'effectuer
	 * la saisie.
	 * 
	 * @param message Le message affiché avant la saisie (si null rien n'est
	 *                affiché).
	...
	/**
	 * Méthode affichant un menu donné en paramètre et demandant à l'utilisateur une
	 * des entrées de ce menu. La méthode affiche le menu et oblige une saisie de
	 * l'utilisateur.
	 * 
	 * @param menu Un tableau de chaîne de caractères représentant les entrées du
	 *             menu.
	...
	/**
	 * Méthode permettant de poser une question binaire à l'utilisateur.
	 * L'utilisateur doit saisir une réponse parmi deux choix.
	 * 
	 * @param question La question posée (doit être non null).
	 * @param choix1   Le premier choix de réponse (doit être non null et contenir
	 *                 au moins un caractère).
	 * @param choix2   Le second choix de réponse (doit être non null et contenir au
	 *                 moins un caractère).
	 * @return true si et seulement si le premier choix a été saisi par
	 *         l'utilisateur.
	 */
